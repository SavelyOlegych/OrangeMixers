        ...
        <div class="header__wrapper container-wide" :class="{'header__wrapper--main-page': isMainPage}">
            <div class="header__left">
                <a class="header__logo-link" href="/">
                    <svg class="header__logo" width="100%" height="100%" viewBox="0 0 126 35" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="header__right">
                <div class="header__phone">
                    <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <g clip-path="url(#clip0_5666_8170)">
